...
class TaskClassifier:
    ...
    def __init__(
        ...
        self.trivial_word_threshold = trivial_word_threshold if trivial_word_threshold is not None else cfg.trivial_word_threshold
        self.moderate_word_threshold = moderate_word_threshold if moderate_word_threshold is not None else cfg.moderate_word_threshold
...
- EXPERT: Research, architecture, novel problems"""
        ...
        ], temperature=cfg.classification_temperature)
